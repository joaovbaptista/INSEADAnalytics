...
<br>
<br>
1) startdate in DataSet1.R should be startDate = "2001-01-01" which it already is.
<br>
2) change in DataSet1.R mytickers = c("SPY", "AAPL") to mytickers = c("SPY", "AAPL","GOOG","TSLA")
<br>
...
<br>
2 - you get an error becasue you are adding a vector (stockreturn) with a list (mydata) 
<br>
<hr>
<hr>
