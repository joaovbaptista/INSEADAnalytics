...
*Factor 5 Euro-bonds and IR 
*Factor 6 Oil
*Factor 7 Metals
*Factor 8 Foods
*Factor 9 Gold & Sliver
*Factor 10 Asian Stock Indices
*4. See comments on charts below.
*5.In the bull market more components influence the market as there are more occurences before the elbow of the chart. You can see for example that component 1 is less significant compared with the average over all the years. *In the bear market a) with the  first 4 factors we can explain  50% of the variance b) The correlation between futures increased.
*
